...
public class msg_position_target_local_ned extends MAVLinkMessage
{
  ...
  public msg_position_target_local_ned(MAVLinkPacket paramMAVLinkPacket)
  {
  ...
  {
    return "MAVLINK_MSG_ID_POSITION_TARGET_LOCAL_NED - time_boot_ms:" + this.time_boot_ms + " x:" + this.x + " y:" + this.y + " z:" + this.z + " vx:" + this.vx + " vy:" + this.vy + " vz:" + this.vz + " afx:" + this.afx + " afy:" + this.afy + " afz:" + this.afz + " yaw:" + this.yaw + " yaw_rate:" + this.yaw_rate + " type_mask:" + this.type_mask + " coordinate_frame:" + this.coordinate_frame + "";
  }
 ...
 * Qualified Name:     com.MAVLink.common.msg_position_target_local_ned
