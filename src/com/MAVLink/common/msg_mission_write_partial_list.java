...
public class msg_mission_write_partial_list extends MAVLinkMessage
{
  ...
  public msg_mission_write_partial_list(MAVLinkPacket paramMAVLinkPacket)
  {
  ...
  {
    return "MAVLINK_MSG_ID_MISSION_WRITE_PARTIAL_LIST - start_index:" + this.start_index + " end_index:" + this.end_index + " target_system:" + this.target_system + " target_component:" + this.target_component + "";
  }
 ...
 * Qualified Name:     com.MAVLink.common.msg_mission_write_partial_list
