...
public class msg_vicon_position_estimate extends MAVLinkMessage
{
  ...
  public msg_vicon_position_estimate(MAVLinkPacket paramMAVLinkPacket)
  {
  ...
  {
    return "MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE - usec:" + this.usec + " x:" + this.x + " y:" + this.y + " z:" + this.z + " roll:" + this.roll + " pitch:" + this.pitch + " yaw:" + this.yaw + "";
  }
 ...
 * Qualified Name:     com.MAVLink.common.msg_vicon_position_estimate
