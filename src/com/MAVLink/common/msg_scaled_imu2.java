...
public class msg_scaled_imu2 extends MAVLinkMessage
{
  ...
  public msg_scaled_imu2(MAVLinkPacket paramMAVLinkPacket)
  {
  ...
  {
    return "MAVLINK_MSG_ID_SCALED_IMU2 - time_boot_ms:" + this.time_boot_ms + " xacc:" + this.xacc + " yacc:" + this.yacc + " zacc:" + this.zacc + " xgyro:" + this.xgyro + " ygyro:" + this.ygyro + " zgyro:" + this.zgyro + " xmag:" + this.xmag + " ymag:" + this.ymag + " zmag:" + this.zmag + "";
  }
 ...
 * Qualified Name:     com.MAVLink.common.msg_scaled_imu2
