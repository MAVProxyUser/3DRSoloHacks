...
public class msg_mission_item_int extends MAVLinkMessage
{
  ...
  public msg_mission_item_int(MAVLinkPacket paramMAVLinkPacket)
  {
  ...
  {
    return "MAVLINK_MSG_ID_MISSION_ITEM_INT - param1:" + this.param1 + " param2:" + this.param2 + " param3:" + this.param3 + " param4:" + this.param4 + " x:" + this.x + " y:" + this.y + " z:" + this.z + " seq:" + this.seq + " command:" + this.command + " target_system:" + this.target_system + " target_component:" + this.target_component + " frame:" + this.frame + " current:" + this.current + " autocontinue:" + this.autocontinue + "";
  }
 ...
 * Qualified Name:     com.MAVLink.common.msg_mission_item_int
