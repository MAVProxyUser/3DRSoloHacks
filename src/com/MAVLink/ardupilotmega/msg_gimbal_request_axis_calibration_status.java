...
public class msg_gimbal_request_axis_calibration_status extends MAVLinkMessage
{
  ...
  public msg_gimbal_request_axis_calibration_status(MAVLinkPacket paramMAVLinkPacket)
  {
  ...
  {
    return "MAVLINK_MSG_ID_GIMBAL_REQUEST_AXIS_CALIBRATION_STATUS - target_system:" + this.target_system + " target_component:" + this.target_component + "";
  }
 ...
 * Qualified Name:     com.MAVLink.ardupilotmega.msg_gimbal_request_axis_calibration_status
