...
public enum AlertType
{
  ...
  static
  {
    PREFLIGHT_SOLO_COMPASS_CALIBRATION = new AlertType("PREFLIGHT_SOLO_COMPASS_CALIBRATION", 3, 0, 3, 2131099737, 2131100032, 2130837632, new OnAlertClickListener()
    {
    ...
    PREFLIGHT_MAG_INTERFERENCE = new AlertType("PREFLIGHT_MAG_INTERFERENCE", 4, 0, 2, 2131099728, 2131099703, 2130837632, null);
    PREFLIGHT_SOLO_LEVEL_CALIBRATION = new AlertType("PREFLIGHT_SOLO_LEVEL_CALIBRATION", 5, 0, 3, 2131099738, 2131100032, 2130837848, new OnAlertClickListener()
    {
      public void onAlertClick(BaseFragment paramAnonymousBaseFragment)
      {
    ...
    PREFLIGHT_SOLO_MUST_BE_LEVEL = new AlertType("PREFLIGHT_SOLO_MUST_BE_LEVEL", 6, 0, 2, 2131099739, 0, 2130837848);
    PREFLIGHT_SHOT_AND_RETURN_NOT_AVAILABLE = new AlertType("PREFLIGHT_SHOT_AND_RETURN_NOT_AVAILABLE", 7, 3, 1, 2131099741, 2131099736, 2130837750, 2131034121, null);
    PREFLIGHT_BATTERY_TOO_LOW = new AlertType("PREFLIGHT_BATTERY_TOO_LOW", 8, 1, 3, 2131099731, 2131099976, 2130837611, 2131034116, true, false, true, null);
    PREFLIGHT_SOLO_NEEDS_SERVICE = new AlertType("PREFLIGHT_SOLO_NEEDS_SERVICE", 9, 0, 3, 2131099740, 2131100033, 2130837858, new OnAlertClickListener()
    {
      public void onAlertClick(BaseFragment paramAnonymousBaseFragment)
      {
    ...
    PREFLIGHT_CRASH_DETECTED = new AlertType("PREFLIGHT_CRASH_DETECTED", 10, 0, 3, 2131099732, 2131100033, 2130837858, 2131034120, new OnAlertClickListener()
    {
      public void onAlertClick(BaseFragment paramAnonymousBaseFragment)
      {
        paramAnonymousBaseFragment.startActivity(new Intent(paramAnonymousBaseFragment.getContext(), SupportActivity.class));
    ...
    TAKEOFF_FOR_SHOT = new AlertType("TAKEOFF_FOR_SHOT", 11, 3, 2, 2131100031, 0, 2130837889);
    PREFLIGHT_CALIBRATION_FAILED = new AlertType("PREFLIGHT_CALIBRATION_FAILED", 12, 0, 2, 2131099854, 2131099745, 2130837848, 2131034120, new OnAlertClickListener()
    {
      public void onAlertClick(BaseFragment paramAnonymousBaseFragment)
      {
        AlertType.launchCompassCalibration(paramAnonymousBaseFragment);
    ...
    PREFLIGHT_CALIBRATING_COMPASS = new AlertType("PREFLIGHT_CALIBRATING_COMPASS", 13, 0, 2, 2131099704, 2131099729, 2130837632);
    PREFLIGHT_THROTTLE_TOO_HIGH = new AlertType("PREFLIGHT_THROTTLE_TOO_HIGH", 14, 0, 2, 2131099747, 0, 2130837889);
    PREFLIGHT_CALIBRATING_SENSORS = new AlertType("PREFLIGHT_CALIBRATING_SENSORS", 15, 0, 2, 2131099705, 0, 2130837750);
    INFLIGHT_FLIGHT_BATTERY_25P = new AlertType("INFLIGHT_FLIGHT_BATTERY_25P", 16, 1, 2, 2131099720, 2131099979, 2130837616, 2131034116, true, true, true, new OnAlertClickListener()
    {
      public void onAlertClick(BaseFragment paramAnonymousBaseFragment)
      {
    ...
    INFLIGHT_CONTROL_BATTERY_5P = new AlertType("INFLIGHT_CONTROL_BATTERY_5P", 17, 2, 2, 2131099717, 2131099966, 2130837611, 2131034115, true, false, true, null);
    INFLIGHT_MAX_ALTITUDE = new AlertType("INFLIGHT_MAX_ALTITUDE", 18, 1, 2, 2131099726, 0, 2130837787, 2131034112, true, true, true, null);
    INFLIGHT_FLIGHT_BATTERY_10P = new AlertType("INFLIGHT_FLIGHT_BATTERY_10P", 19, 1, 3, 2131099719, 2131099979, 2130837613, 2131034116, true, false, true, null);
    INFLIGHT_FLIGHT_BATTERY_3P = new AlertType("INFLIGHT_FLIGHT_BATTERY_3P", 20, 1, 3, 2131099721, 2131099750, 2130837611, 2131034116, true, false, true, null);
    INFLIGHT_GPS_LOST = new AlertType("INFLIGHT_GPS_LOST", 21, 0, 3, 2131099724, 2131100030, 2130837750, 2131034121, null);
    INFLIGHT_GPS_LOCK = new AlertType("INFLIGHT_GPS_LOCK", 22, 0, 0, 2131099723, 2131099981, 2130837750, 2131034121, true, true, false, null);
    INFLIGHT_CONTROLLER_SIGNAL_LOST = new AlertType("INFLIGHT_CONTROLLER_SIGNAL_LOST", 23, 0, 3, 2131099718, 2131099980, 2130837945, 2131034128, null);
    INFLIGHT_CONTROLLER_SIGNAL_RECOVERY = new AlertType("INFLIGHT_CONTROLLER_SIGNAL_RECOVERY", 24, 3, 0, 2131099743, 2131099742, 0, true);
    INFLIGHT_CONTROLLER_SIGNAL_LOST_NO_GPS = new AlertType("INFLIGHT_CONTROLLER_SIGNAL_LOST_NO_GPS", 25, 0, 3, 2131099718, 2131099706, 2130837945, 2131034128, null);
    INFLIGHT_CONTROL_BATTERY_0P_RETURNING = new AlertType("INFLIGHT_CONTROL_BATTERY_0P_RETURNING", 26, 2, 3, 2131099714, 2131099980, 2130837611, 2131034128, true, false, true, null);
    INFLIGHT_CONTROL_BATTERY_0P_LANDING = new AlertType("INFLIGHT_CONTROL_BATTERY_0P_LANDING", 27, 2, 3, 2131099714, 2131099750, 2130837611, 2131034120, true, false, true, null);
    FOLLOW_INACCURATE_LOCATION = new AlertType("FOLLOW_INACCURATE_LOCATION", 28, 3, 2, 2131099707, 0, 2130837750);
    FOLLOW_UNAVAILABLE_LOCATION = new AlertType("FOLLOW_UNAVAILABLE_LOCATION", 29, 3, 3, 2131099708, 0, 2130837750, 2131034112, true, true, false, null);
    POOR_CONTROLLER_CONNECTION = new AlertType("POOR_CONTROLLER_CONNECTION", 30, 3, 3, 2131099730, 2131099746, 2130837945, new OnAlertClickListener()
    {
      public void onAlertClick(BaseFragment paramAnonymousBaseFragment)
      {
    ...
    POOR_CONNECTION_TO_SOLO = new AlertType("POOR_CONNECTION_TO_SOLO", 31, 3, 2, 2131099727, 0, 2130837945, 2131034112, true, false, true, null);
  ...
  protected static void launchAccelCalibration(BaseFragment paramBaseFragment)
  {
    ...
    localBundle.putInt("extra_sub_settings_selected_pane_id", 2131493280);
    localBundle.putBoolean("extra_sub_settings_open_detail_pane", true);
    paramBaseFragment.startActivity(new Intent(paramBaseFragment.getContext(), SettingsActivity.class).putExtra("extra_settings_selected_pane_id", 2131493140).putExtra("extra_settings_open_detail_pane", true).putExtra("extra_settings_arguments", localBundle));
  }

  protected static void launchCompassCalibration(BaseFragment paramBaseFragment)
  {
    Bundle localBundle = new Bundle();
    localBundle.putInt("extra_sub_settings_selected_pane_id", 2131493281);
    localBundle.putBoolean("extra_sub_settings_open_detail_pane", true);
    paramBaseFragment.startActivity(new Intent(paramBaseFragment.getContext(), SettingsActivity.class).putExtra("extra_settings_selected_pane_id", 2131493140).putExtra("extra_settings_open_detail_pane", true).putExtra("extra_settings_arguments", localBundle));
  }
