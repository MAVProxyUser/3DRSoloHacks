...
public class SoloApp extends Application
{
  ...
  public void onCreate()
  {
    ...
    String str = IdUtils.getID(localContext);
    this.appAnalytics = new AppAnalytics(localContext, str);
    MixpanelAPI.People localPeople = MixpanelAPI.getInstance(this, getString(2131099993)).getPeople();
    localPeople.identify(str);
    localPeople.initPushHandling(getString(2131099750));
