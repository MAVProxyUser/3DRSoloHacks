...
public class SlidePaneLayout extends ViewGroup
{
  ...
  private boolean mIsTouchEventInterceptDisallowed;
  ...
  public SlidePaneLayout(Context paramContext)
  {
    this(paramContext, null);
  }

  public SlidePaneLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }

  public SlidePaneLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    float f = paramContext.getResources().getDisplayMetrics().density;
    this.mOverhangSize = ((int)(0.5F + 0.0F * f));
  ...
  public void disallowInterceptTouchEvent(boolean paramBoolean)
  {
    this.mIsTouchEventInterceptDisallowed = paramBoolean;
  }
  ...
  {
    if (this.mIsTouchEventInterceptDisallowed)
      return false;
    ...
    label107: for (boolean bool5 = true; ; bool5 = false)
    {
  ...
  class AccessibilityDelegate extends AccessibilityDelegateCompat
  {
    ...
    {
      return SlidePaneLayout.this.isDimmed(paramView);
    }

    public void onInitializeAccessibilityEvent(View paramView, AccessibilityEvent paramAccessibilityEvent)
    {
      super.onInitializeAccessibilityEvent(paramView, paramAccessibilityEvent);
      paramAccessibilityEvent.setClassName(SlidePaneLayout.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(View paramView, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
    {
      ...
      paramAccessibilityNodeInfoCompat.setClassName(SlidePaneLayout.class.getName());
      ...
      int i = SlidePaneLayout.this.getChildCount();
      for (int j = 0; j < i; j++)
      {
        View localView = SlidePaneLayout.this.getChildAt(j);
  ...
  private class DragHelperCallback extends ViewDragHelper.Callback
  {
    ...
    {
      SlidePaneLayout.LayoutParams localLayoutParams = (SlidePaneLayout.LayoutParams)SlidePaneLayout.this.mSlideableView.getLayoutParams();
      if (SlidePaneLayout.this.isLayoutRtlSupport())
      {
        int k = SlidePaneLayout.this.getWidth() - (SlidePaneLayout.this.getPaddingRight() + localLayoutParams.rightMargin + SlidePaneLayout.this.mSlideableView.getWidth());
        int m = k - SlidePaneLayout.this.mSlideRange;
        return Math.max(Math.min(paramInt1, k), m);
      }
      int i = SlidePaneLayout.this.getPaddingLeft() + localLayoutParams.leftMargin;
      int j = i + SlidePaneLayout.this.mSlideRange;
    ...
    {
      SlidePaneLayout.this.mDragHelper.captureChildView(SlidePaneLayout.this.mSlideableView, paramInt2);
    }
    ...
    public void onViewDragStateChanged(int paramInt)
    {
      if (SlidePaneLayout.this.mDragHelper.getViewDragState() == 0)
      {
        ...
        {
          SlidePaneLayout.this.updateObscuredViewsVisibility(SlidePaneLayout.this.mSlideableView);
          SlidePaneLayout.this.dispatchOnPanelClosed(SlidePaneLayout.this.mSlideableView);
          SlidePaneLayout.access$502(SlidePaneLayout.this, false);
        }
      }
      else
        return;
      SlidePaneLayout.this.dispatchOnPanelOpened(SlidePaneLayout.this.mSlideableView);
      SlidePaneLayout.access$502(SlidePaneLayout.this, true);
    }

    public void onViewPositionChanged(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
    {
      SlidePaneLayout.this.onPanelDragged(paramInt1);
      SlidePaneLayout.this.invalidate();
    }

    public void onViewReleased(View paramView, float paramFloat1, float paramFloat2)
    {
      SlidePaneLayout.LayoutParams localLayoutParams = (SlidePaneLayout.LayoutParams)paramView.getLayoutParams();
      int i;
      if (SlidePaneLayout.this.isLayoutRtlSupport())
      {
        int j = SlidePaneLayout.this.getPaddingRight() + localLayoutParams.rightMargin;
        if ((paramFloat1 < 0.0F) || ((paramFloat1 == 0.0F) && (SlidePaneLayout.this.mSlideOffset > 0.5F)))
          j += SlidePaneLayout.this.mSlideRange;
        int k = SlidePaneLayout.this.mSlideableView.getWidth();
        i = SlidePaneLayout.this.getWidth() - j - k;
      }
      while (true)
      {
        SlidePaneLayout.this.mDragHelper.settleCapturedViewAt(i, paramView.getTop());
        SlidePaneLayout.this.invalidate();
        return;
        i = SlidePaneLayout.this.getPaddingLeft() + localLayoutParams.leftMargin;
        if ((paramFloat1 > 0.0F) || ((paramFloat1 == 0.0F) && (SlidePaneLayout.this.mSlideOffset > 0.5F)))
          i += SlidePaneLayout.this.mSlideRange;
      }
    }
    ...
    public boolean tryCaptureView(View paramView, int paramInt)
    {
      if (SlidePaneLayout.this.mIsUnableToDrag)
        return false;
      return ((SlidePaneLayout.LayoutParams)paramView.getLayoutParams()).slideable;
    }
  }
  ...
  static class SavedState extends View.BaseSavedState
  {
    ...
    {
      public SlidePaneLayout.SavedState createFromParcel(Parcel paramAnonymousParcel)
      {
        return new SlidePaneLayout.SavedState(paramAnonymousParcel, null);
      }

      public SlidePaneLayout.SavedState[] newArray(int paramAnonymousInt)
      {
        return new SlidePaneLayout.SavedState[paramAnonymousInt];
      }
    };
    boolean isOpen;
  ...
  public static class SimplePanelSlideListener
    implements SlidePaneLayout.PanelSlideListener
  {
  ...
  {
    public abstract void invalidateChildRegion(SlidePaneLayout paramSlidePaneLayout, View paramView);
  }

  static class SlidingPanelLayoutImplBase
    implements SlidePaneLayout.SlidingPanelLayoutImpl
  {
    public void invalidateChildRegion(SlidePaneLayout paramSlidePaneLayout, View paramView)
    {
      ViewCompat.postInvalidateOnAnimation(paramSlidePaneLayout, paramView.getLeft(), paramView.getTop(), paramView.getRight(), paramView.getBottom());
    }
  }

  static class SlidingPanelLayoutImplJB extends SlidePaneLayout.SlidingPanelLayoutImplBase
  {
    ...
    public void invalidateChildRegion(SlidePaneLayout paramSlidePaneLayout, View paramView)
    {
      if ((this.mGetDisplayList != null) && (this.mRecreateDisplayList != null))
        try
        {
          ...
          super.invalidateChildRegion(paramSlidePaneLayout, paramView);
          return;
        }
  ...
  static class SlidingPanelLayoutImplJBMR1 extends SlidePaneLayout.SlidingPanelLayoutImplBase
  {
    public void invalidateChildRegion(SlidePaneLayout paramSlidePaneLayout, View paramView)
    {
      ViewCompat.setLayerPaint(paramView, ((SlidePaneLayout.LayoutParams)paramView.getLayoutParams()).dimPaint);
    }
  }
}

/* Location:           /Users/kfinisterre/Desktop/Solo/3DRSoloHacks/unpacked_apk/classes_dex2jar.jar
 * Qualified Name:     com.o3dr.solo.android.widget.SlidePaneLayout
