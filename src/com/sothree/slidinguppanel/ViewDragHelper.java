      ...
      if ((i4 & this.mTrackingEdges) != 0)
      {
        ...
        else if (this.mDragState == 2)
        {
          ...
          if (localView2 == this.mCapturedView)
          {
            ...
            label374: float f3;
            float f4;
            while ((m < k) && (this.mInitialMotionX != null) && (this.mInitialMotionY != null))
            {
              n = MotionEventCompat.getPointerId(paramMotionEvent, m);
              if ((n >= this.mInitialMotionX.length) || (n >= this.mInitialMotionY.length))
              {
                m++;
              }
              else
            ...
            while (true)
            {
              saveLastMotion(paramMotionEvent);
              break;
              label446: View localView1 = findTopChildUnder((int)this.mInitialMotionX[n], (int)this.mInitialMotionY[n]);
 ...
 * Qualified Name:     com.sothree.slidinguppanel.ViewDragHelper
